...
after_initialize do
  ...
  class ::ApplicationController
    ...
    def set_images_guardian_cookie
      igc_val, igc_exp = (!SiteSetting.images_guardian_enabled || (SiteSetting.images_guardian_enabled && current_user)) ? [
        ENV["IGUARD_COOKIE"],
        1.week.from_now
      ] : ["", 1.year.ago]
  ...
  class ::SiteSetting
    class << self
      ...
      [
        ...
        :site_x_summary_large_image_url,
        :site_opengraph_image_url,
        :site_push_notifications_icon_url,
        :site_logo_url,
        :site_logo_small_url,
        ...
        trans = m.to_s.gsub(/site\_/, "").gsub(/\_url/, "")
